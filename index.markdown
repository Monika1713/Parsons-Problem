<div id="Mein eigenes Parsons-Problem-sortableTrash" class="sortable-code"></div> 
<div id="Mein eigenes Parsons-Problem-sortable" class="sortable-code"></div> 
<div style="clear:both;"></div> 
<p> 
    <input id="Mein eigenes Parsons-Problem-feedbackLink" value="Get Feedback" type="button" /> 
    <input id="Mein eigenes Parsons-Problem-newInstanceLink" value="Reset Problem" type="button" /> 
</p> 
